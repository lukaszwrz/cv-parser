package pl.wrzaszcz.cvparser.processor;
    ...
    private void loadFile(File file) {
        try (InputStream inputStream = FileUtils.openInputStream(file)) {
            ...
            for (String line : lines) {
                ...
                while (matcher.find()) {
                    this.loadFile(new ClassPathResource(matcher.group(1)).getFile());
                    breakLine = true;
                }
                ...
                while (matcher.find()) {
                    try (InputStream loadFileStream = FileUtils.openInputStream(new ClassPathResource(matcher.group(1)).getFile())) {
